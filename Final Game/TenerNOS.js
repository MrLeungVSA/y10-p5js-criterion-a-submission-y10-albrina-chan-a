...
function preloadTenerNOS()
{
	buttonTENGEMOS = loadImage('https://mrleungvsa.github.io/y10-p5js-criterion-a-submission-y10-albrina-chan-a/Hard Game/tener/yo/button_tengemos.png')
	buttonTIENEMOS = loadImage('https://mrleungvsa.github.io/y10-p5js-criterion-a-submission-y10-albrina-chan-a/Hard Game/tener/yo/button_tienemos.png')
...
function setupTenerNOS()
{
  
}


function drawTenerNOS()
{
	background(32,32,32)
	
	fill(225,225,225)
	text("What is the first person plural (We) ending for the verb tener in present tense?",30,100)
